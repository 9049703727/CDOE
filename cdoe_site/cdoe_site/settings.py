"""
Django settings for cdoe_site project.
...
SECRET_KEY = 'django-insecure-#3wrulug(yyv(!vzki=d%5!^i2@zf4j3*&n8+1tvk^pdf_&ixf'
...
WSGI_APPLICATION = 'cdoe_site.wsgi.application'
...
# Additional static and media settings
